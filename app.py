...
st.title('Data Science Jobs Salary Predictor Application by MOSTOFA AHSAN')
st.write(""" 
This app predicts the **Salary** for data science jobs and its predicition is based on Machine Learning Algorithms. The ML model has been trained with historical data which helps in predicting the 
salary accurately.
""")
...
for i in range(len(list_of_revenue)):
    if list_of_revenue[i] == "-1":
        list_of_revenue[i] = "1 to 5 billion (USD)"
        break
...
if revenue == "1 to 5 million (USD)":
    Revenue_1 = 1
elif revenue =="Less than 10 million (USD)":
...
elif revenue == "10 to 50 billion (USD)":#5
    Revenue_10_to_50_billion = 1
elif revenue == "10 to 50 million (USD)":
    Revenue_10_to_50_million = 1
elif revenue == "100 to 500 billion (USD)":
    Revenue_100_to_500_billion = 1
elif revenue == "10 to 500 million (USD)":
    Revenue_100_to_500_million = 1
elif revenue == "5 to 10 billion (USD)":
    Revenue_5_to_10_billion = 1
elif revenue == "50 to 100 billion (USD)":
...
elif revenue == "500+ billion (USD)":#13
